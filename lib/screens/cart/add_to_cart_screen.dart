...
class AddToCartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        final selectedItems =
            controller.cartItems.where((p) => p.isSelected).toList();
      ...
      () => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _row(
              "Discounted Subtotal (30% OFF)",
              "₹${(controller.subTotal - controller.discountAmount).toStringAsFixed(2)}",
            ),
            _row(
              "Shipping Charges",
              "₹${controller.subTotal == 0 ? 0 : controller.shippingFee}",
            ),
            const Divider(),
            _row(
              "Total",
                                  ...
                                  try {
                                    String? userEmail =
                                        FirebaseAuth
                                            ...
                                            .currentUser
                                            ?.email;
                                    await controller.saveOrderToFirestore(
                                      userEmail!,
                                    );
